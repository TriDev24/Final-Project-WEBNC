...
import { TransferType } from '../../constants/transfer-type.constant.js';
...
function DebitTable({ side }) {
    ...
    const fetchApi = async (side) => {
        const url = `${process.env.REACT_APP_DEBIT_URL_PATH}?accountNumber=${paymentAccountNumber}&side=${side}`;
    ...
    function Action({
        ...
        const payDebit = async () => {
            ...
            const internalBankType = bankTypes.find(
                (b) => b.name === 'My Bank'
            );
            ...
            const payload = {
                ...
                description: foundedDebit.content,
        ...
        return (
            <Space>
                ...
                <DeleteDebitModal
                    ...
                    fetchApi={fetchApi}></DeleteDebitModal>
            </Space>
        );
    }
